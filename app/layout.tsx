  ...
  return (
    <html lang="fr">
      <head>
        ...
        <meta
          property="og:title"
          content="Sunline Energie - Expert du Photovoltaïque"
        />
        <meta
          property="og:description"
          content="Découvrez Sunline, expert des panneaux photovoltaïques en Nouvelle-Aquitaine. Solutions sur mesure, et services professionnels pour particuliers et entreprises."
        />
